    ...
    @foreach ($folders as $folder)
        <div class="bg-white p-6 rounded-xl border-t-4 border-blue-400 space-y-4 relative">
            <div class=" relative flex items-center justify-between">
                ...
                <button @click="openFolder = openFolder === {{ $folder->id }} ? null : {{ $folder->id }}" class="cursor-pointer text-gray-500">
            ...
            >
                ...
                <button wire:click="deleteFolder({{ $folder->id }})" class="hover:bg-gray-100 py-1.5 px-4 w-full rounded-md text-red-500 text-start cursor-pointer">Delete</button>
            </div>
