<div
        x-show="$wire.showCreateQuestionModal"
        x-cloak
    ...
    >
        ...
        >
            ...
            <div wire:show='!type' class="rounded-xl border border-dashed border-gray-300 bg-gray-50 p-4 text-sm text-gray-600">
            ...
            <div class="grid grid-cols-2 gap-4">
                <button
                    wire:click='closeCreateQuestionModal'
                    type="button"
